...
{
    auto category_file_name = options_.category_file_name;
...
{
    auto input_directory_names = options_.input_directory_names;
    ...
    auto bad_paths = service.badPaths();
    if (!bad_paths.empty()) {
